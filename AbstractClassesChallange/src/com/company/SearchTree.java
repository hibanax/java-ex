...
public class SearchTree implements NodeList {
    ...
    ListItem currentItem = this.root;
        ...
        if(comparison < 0) {
            ...
            if(currentItem.next() != null) {
                ...
                // The is no next, so insert at end of list
    ...
    private void performRemoval(ListItem item, ListItem parent) {
        ...
        if(item.next() == null) {
            ...
            // neither left no right are null, deletion is now a lot trickier!
            // From the right sub-tree, find the smallet value (i.e., the leftmost)
            ...
            if(leftmostParent == item) {
                ...
                // set the smallest node's parent to points to
